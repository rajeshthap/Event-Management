    ...
    <>
      <div className='top-nav d-flex align-items-center'>
        <container className='container-fluid container-xl d-flex justify-content-center justify-content-md-between'>
          <div className='d-flex align-items-center'>
          ...
          </div> <div className='social-links d-none d-md-flex align-items-center'><ul class="event-social-link">

            <li>
              <a href="#" data-discover="true">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" className="social-icon facebook-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a href="#" data-discover="true">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className="social-icon twitter-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a href="#" data-discover="true">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" className="social-icon whatsapp-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a className="text-light" href="#" data-discover="true">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" className="social-icon instagram-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">

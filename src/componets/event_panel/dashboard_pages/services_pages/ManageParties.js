...
const ManageParties = () => {
  ...
  const fetchCorporateEventItemData = async (itemId) => {
    ...
    try {
      ...
      const response = await authFetch(
        `https://mahadevaaya.com/eventmanagement/eventmanagement_backend/api/private-parties-event-service/?id=${itemId}`
      );
        ...
        <div className="main-content-dash">
          ...
          <Container fluid className="dashboard-body dashboard-main-container">
            <div className="d-flex justify-content-between align-items-center mb-4">
              <h1 className="page-title mb-0">Manage Parties Events</h1>

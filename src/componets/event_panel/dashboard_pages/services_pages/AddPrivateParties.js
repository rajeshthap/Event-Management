  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setTimeout(() => {
          navigate("/ManageParties"); // Change this to your actual list page
        }, 2000);
      } else {
      ...
      <div className="dashboard-container">
        ...
        <div className="main-content-dash">
          ...
          <Container fluid className="dashboard-body dashboard-main-container">
            <h1 className="page-title">Add Parties Event Service Item</h1>
...
export default AddPrivateParties;
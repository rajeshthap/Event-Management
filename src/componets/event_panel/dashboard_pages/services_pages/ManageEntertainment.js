...
const ManageEntertainment = () => {
  ...
  const fetchAllCorporateEventItems = async () => {
    ...
    try {
      const response = await authFetch(
        "https://mahadevaaya.com/eventmanagement/eventmanagement_backend/api/entertainment-event-service-item/"
      );
  ...
  const fetchCorporateEventItemData = async (itemId) => {
    ...
    try {
      ...
      const response = await authFetch(
        `https://mahadevaaya.com/eventmanagement/eventmanagement_backend/api/entertainment-event-service-item/?id=${itemId}`
      );
